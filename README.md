# genpark-studio-grade-acoustic-voice-isolation-denoiser-skill
...
> **GenPark AI Agent Skill** -- Studio-grade acoustic voice isolation and room denoiser (ElevenLabs style)
